    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='page_admin', to='user.user')),
                ('college', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='user.college')),
                ('members', models.ManyToManyField(blank=True, related_name='page_members', to='user.User')),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
